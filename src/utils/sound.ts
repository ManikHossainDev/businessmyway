...
// Works across all modern browsers without external asset loading issues
...
/**
 * Plays a pleasant, crystal-clear 2-tone chime notification sound.
 */
export const playNotificationSound = (): void => {
  try {
    ...
    // Second tone (A5 - 880.00 Hz) - higher pleasant resolution
