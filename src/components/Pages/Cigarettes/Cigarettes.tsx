...
export const products: Product[] = [
  { id: 1, name: 'Davidoff Classic', brand: 'Davidoff', strength: 'Medium', flavour: 'Classic', packSize: '20 Pack', price: 12.5, image: 'https://i.ibb.co/3HzsqWL/image-23.png' },
  { id: 2, name: 'Davidoff Gold', brand: 'Davidoff', strength: 'Light', flavour: 'Classic', packSize: '10 Pack', price: 7.0, image: 'https://i.ibb.co/3HzsqWL/image-23.png' },
  { id: 3, name: 'Davidoff Menthol', brand: 'Davidoff', strength: 'Light', flavour: 'Menthol', packSize: '20 Pack', price: 13.0, image: 'https://i.ibb.co/3HzsqWL/image-23.png' },
  { id: 4, name: 'Marlboro Red', brand: 'Marlboro', strength: 'Full Strength', flavour: 'Classic', packSize: '20 Pack', price: 11.5, image: 'https://i.ibb.co/3HzsqWL/image-23.png' },
  { id: 5, name: 'Marlboro Gold', brand: 'Marlboro', strength: 'Light', flavour: 'Classic', packSize: '20 Pack', price: 11.5, image: 'https://i.ibb.co/3HzsqWL/image-23.png' },
  { id: 6, name: 'Marlboro Ice Blast', brand: 'Marlboro', strength: 'Medium', flavour: 'Menthol', packSize: '10 Pack', price: 6.5, image: 'https://i.ibb.co/3HzsqWL/image-23.png' },
  { id: 7, name: 'Dunhill Fine Cut', brand: 'Dunhill', strength: 'Ultra Light', flavour: 'Classic', packSize: '20 Pack', price: 12.0, image: 'https://i.ibb.co/3HzsqWL/image-23.png' },
  { id: 8, name: 'Dunhill Menthol', brand: 'Dunhill', strength: 'Medium', flavour: 'Menthol', packSize: 'Carton x 10', price: 95.0, image: 'https://i.ibb.co/3HzsqWL/image-23.png' },
  { id: 9, name: 'Dunhill Vanilla Mix', brand: 'Dunhill', strength: 'Light', flavour: 'Vanilla', packSize: '20 Pack', price: 12.5, image: 'https://i.ibb.co/3HzsqWL/image-23.png' },
  { id: 10, name: 'Davidoff Carton', brand: 'Davidoff', strength: 'Full Strength', flavour: 'Classic', packSize: 'Carton x 10', price: 98.0, image: 'https://i.ibb.co/3HzsqWL/image-23.png' },
];
